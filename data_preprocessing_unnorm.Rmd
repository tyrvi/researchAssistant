...
data.list.nobladder = list(gtex.breast, gtex.prostate, gtex.thyroid, tcga.breast, tcga.prostate, tcga.thyroid)
data.list.nobreast = list(gtex.bladder, gtex.prostate, gtex.thyroid, tcga.bladder, tcga.prostate, tcga.thyroid)
...
data.nobladder = Reduce(function(x, y) {
    merge(x, y, by=c('Hugo_Symbol', 'Entrez_Gene_Id'))
  }, data.list.nobladder)

data.nobreast = Reduce(function(x, y) {
    merge(x, y, by=c('Hugo_Symbol', 'Entrez_Gene_Id'))
  }, data.list.nobreast)
...
# clean up
rm(data.list, data.list.gtex, data.list.tcga, data.list.nobladder, data.list.nobreast)
```
...
rownames(data.nobladder) = data.nobladder[,1]
data.nobladder[,1:2] = NULL

rownames(data.nobreast) = data.nobreast[,1]
data.nobreast[,1:2] = NULL
```
...
data.nobladder = data.nobladder[-which(rowMeans(data.nobladder[,]) <= 0.01), ]
data.nobreast = data.nobreast[-which(rowMeans(data.nobreast[,]) <= 0.01), ]
