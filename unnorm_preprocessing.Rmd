...
```{r}
log.gtex = data.log@pca.scores[grep("GTEX", rownames(data.log@pca.scores)), ]
log.tcga = data.log@pca.scores[grep("TCGA", rownames(data.log@pca.scores)), ]

norm.gtex = data.norm@pca.scores[grep("GTEX", rownames(data.norm@pca.scores)), ]
norm.tcga = data.norm@pca.scores[grep("TCGA", rownames(data.norm@pca.scores)), ]

qn.gtex = data.qn@pca.scores[grep("GTEX", rownames(data.qn@pca.scores)), ]
qn.tcga = data.qn@pca.scores[grep("TCGA", rownames(data.qn@pca.scores)), ]
```

### Write PCA data to file for input to neural network
Write respective batches
```{r}
write.csv(log.gtex[, 1:20], file = "data/processed/unnorm-log-20PC-GTEX-breast-prostate-thyroid.csv", row.names = TRUE)
write.csv(log.tcga[, 1:20], file = "data/processed/unnorm-log-20PC-TCGA-breast-prostate-thyroid.csv", row.names = TRUE)

write.csv(norm.gtex[, 1:20], file = "data/processed/unnorm-norm-20PC-GTEX-breast-prostate-thyroid.csv", row.names = TRUE)
write.csv(norm.tcga[, 1:20], file = "data/processed/unnorm-norm-20PC-TCGA-breast-prostate-thyroid.csv", row.names = TRUE)

write.csv(qn.gtex[, 1:20], file = "data/processed/unnorm-qn-20PC-GTEX-breast-prostate-thyroid.csv", row.names = TRUE)
write.csv(qn.tcga[, 1:20], file = "data/processed/unnorm-qn-20PC-TCGA-breast-prostate-thyroid.csv", row.names = TRUE)
...
```{r}
write.csv(data@pca.scores[, 1:20], file = "data/processed/unnorm-20PC-df-breast-prostate-thyroid.csv", row.names = TRUE)
write.csv(data.log@pca.scores[, 1:20], file = "data/processed/unnorm-log-20PC-df-breast-prostate-thyroid.csv", row.names = TRUE)
write.csv(data.norm@pca.scores[, 1:20], file = "data/processed/unnorm-norm-20PC-df-breast-prostate-thyroid.csv", row.names = TRUE)
write.csv(data.qn@pca.scores[, 1:20], file = "data/processed/unnorm-qn-20PC-df-breast-prostate-thyroid.csv", row.names = TRUE)
```